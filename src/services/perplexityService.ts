...
- Если в чеке написано "Гуакамоле 200г - 1.95€", то quantity=1 (одна упаковка), price=1.95
- Если в чеке написано "Яблоки 0.5 X 2.99", то quantity=0.5 (кг), price=(результат умножения)
- Если в чеке написано "Молоко 3 X 1.50", то quantity=3 (шт), price=4.50 (итоговая цена)
- НЕ указывай вес продукта как quantity, если это упакованный товар!
- Упакованные товары (с указанием веса в названии типа "200г", "1L") всегда имеют quantity=1
