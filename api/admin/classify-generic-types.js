...
const SYSTEM_PROMPT = [
  ...
  '  "Cerveja Super Bock 33cl" → "пиво алкогольное"',
  '  "Cerveja SEM ÁLCOOL Super Bock 33cl" → "пиво безалкогольное"',
  '  "Sidra Bandida Pomar 50cl" → "сидр"',
  '  "Café Descafeinado Pingo Doce" → "кофе без кофеина"',
  'Rules:',
  ...
  '  - IMPORTANT: distinguish alcoholic vs non-alcoholic beverages. "SEM ÁLCOOL" / "0.0%" / "без алкоголя" → suffix "безалкогольное" (e.g. "пиво безалкогольное", "вино безалкогольное"). Otherwise plain "пиво", "вино".',
  '  - Cider ("sidra") is its own type "сидр", NOT "пиво", even if alcoholic.',
  '  - Decaf coffee ("descafeinado", "sem cafeína") → "кофе без кофеина"; regular → "кофе".',
  '  - Lowercase.',
